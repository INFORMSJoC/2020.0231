function maxmin(t, cone, a, z)
    ...
    m2 = Model(solver=BaronSolver(CplexLibName="/panfs/roc/groups/10/qizh/rishabh/Mangi/CPLEX_Studio128/cplex/bin/x86-64_linux/libcplex1280.so", PrLevel = 0, MaxTime = 200))

    epsilon = 1

    @variable(m2, 10 >= y[1:n] >= -5)
